...
#20.times do |n|
#  Hotel.create!(title: Faker::Company.name, stars: rand(2..5), breakfast: random_boolean = [true, false].sample, description: Faker::Lorem.paragraph(4, true, 4), price: Faker::Number.decimal(2), user_id: User.find(rand(1..10)).id)
#end
...
#  AdvCategory.create!(name: "Category#{n}", parent_category_id: AdvCategory.find(rand(1..(n + 1))).id), owner_id: User.find(rand(1..2)).id
